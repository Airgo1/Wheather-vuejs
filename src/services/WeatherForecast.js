...
class WeatherForecast {
    ...
    */
    async updateForecastCoord(position) {
        let data = null;

        try {
            data = await this.getForecastCoord(position.coords);
        } catch (e) {
    ...
    /*
    * Update forecast from given city data.
    *
    * @param {String} city.
    */
    async updateForecastCity(city) {
        let data = null;

        try {
            data = await this.getForecastCity(city);
        } catch (e) {
    ...
    */
    async getForecastCoord(coordinates) {
        let appId = 'cc54d6d787b9df9368f501e4d639d805';
    ...
    * @param {String} city .
    */
    async getForecastCity(cityname) {
        let appId = 'cc54d6d787b9df9368f501e4d639d805';
        let endpoint = `https://api.openweathermap.org/data/2.5/weather?q=${cityname}&appid=${appId}&units=metric`;
